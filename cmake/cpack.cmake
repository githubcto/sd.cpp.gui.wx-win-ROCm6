...
if(WIN32)
    ...
    install(FILES ${CMAKE_SOURCE_DIR}/ROCm/stablediffusiongui-win-FORCE-ROCm62.bat DESTINATION ${bin_INSTALL_PATH_NSIS} COMPONENT "${CMAKE_PROJECT_NAME}")
    install(FILES ${CMAKE_SOURCE_DIR}/ROCm/stablediffusiongui-win-FORCE-vulkan.bat DESTINATION ${bin_INSTALL_PATH_NSIS} COMPONENT "${CMAKE_PROJECT_NAME}")
    install(FILES ${CMAKE_SOURCE_DIR}/ROCm/stablediffusiongui-win-ROCm62-HIP_VISIBLE_DEVICES0.bat DESTINATION ${bin_INSTALL_PATH_NSIS} COMPONENT "${CMAKE_PROJECT_NAME}")
    install(FILES ${CMAKE_SOURCE_DIR}/ROCm/stablediffusiongui-win-ROCm62-HIP_VISIBLE_DEVICES1.bat DESTINATION ${bin_INSTALL_PATH_NSIS} COMPONENT "${CMAKE_PROJECT_NAME}")
